...
# Create updated docker-compose.prod.yml with Redis authentication
...
# Export the Redis password as environment variable
export REDIS_PASSWORD

echo "📝 Updated docker-compose.prod.yml with Redis authentication"
...
echo "🚀 Starting services with Redis authentication..."
...
docker exec ab-back-app-1 redis-cli -h redis -p 6379 -a "$REDIS_PASSWORD" ping
