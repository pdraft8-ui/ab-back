...
const AhliaAccidentReportSchema = new Schema({
  ...
  accidentDetails: {
    ...
    accidentType: {
      type: String,
      enum: ["physical", "material", "physicalAndMaterial"],
    },
    sketch: { type: String },
  ...
  thirdPartyPassengers: [{ name: { type: String } }],

  externalWitnesses: [{ name: { type: String } }],
...
const AhliAccidentReportModel = mongoose.model(
  "AhliAccidentReport",
  AhliaAccidentReportSchema
);
