...
export class DepartmentContainer {
  constructor() {
    ...
    this.getAllDepartmentsUseCase = new GetAllDepartmentsUseCase(
      this.departmentRepository
    );
    ...
    this.deleteDepartmentUseCase = new DeleteDepartmentUseCase(
      this.departmentRepository
    );
    this.getDepartmentStatsUseCase = new GetDepartmentStatsUseCase(
      this.departmentRepository
    );
    this.departmentController = new DepartmentController(
      this.createDepartmentUseCase,
      this.getAllDepartmentsUseCase,
      this.getDepartmentByIdUseCase,
      this.updateDepartmentUseCase,
      this.deleteDepartmentUseCase,
      this.getDepartmentStatsUseCase
    );
