...
export {
  DepartmentContainer,
  DepartmentContainerMinimal,
} from "./infrastructure/container/DepartmentContainer.js";

// Route factory function
export async function getDepartmentRoutes() {
  const { DepartmentContainer } = await import(
    "./infrastructure/container/DepartmentContainer.js"
  );
...
export async function getDepartmentContainerMinimal() {
  const { DepartmentContainerMinimal } = await import(
    "./infrastructure/container/DepartmentContainer.js"
  );
