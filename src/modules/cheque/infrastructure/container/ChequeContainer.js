...
export class ChequeContainer {
  ...
  initializeServices() {
    ...
    this.services.set(
      "createChequeUseCase",
      new CreateChequeUseCase(
        this.services.get("chequeRepository"),
    ...
    this.services.set(
      ...
      new GetAllChequesUseCase(this.services.get("chequeRepository"))
    );

    // Initialize controller
    this.services.set(
      "chequeController",
      new ChequeController(
        this.services.get("createChequeUseCase"),
        this.services.get("getAllChequesUseCase")
      )
    );
    ...
    this.services.set(
      "chequeRoutes",
      new ChequeRoutes(this.services.get("chequeController"))
    );
  }
