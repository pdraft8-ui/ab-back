...
export class MongoPalestineAccidentReportRepository extends IPalestineAccidentReportRepository {
  ...
  async create(palestineAccidentReport) {
    try {
      ...
      const mongooseDoc = await PalestineAccidentReportModel.create(
        accidentData
      );
      return this.mapToPalestineAccidentReportEntity(mongooseDoc);
    } catch (error) {
      throw new Error(
        `Failed to create PalestineAccidentReport: ${error.message}`
      );
    }
  }
  ...
  async findById(id) {
    try {
      ...
      throw new Error(
        `Failed to find PalestineAccidentReport by ID: ${error.message}`
      );
    }
  }
  ...
  async findByCustomerId(customerId) {
    try {
      ...
      return mongooseDocs.map((doc) =>
        this.mapToPalestineAccidentReportEntity(doc)
      );
    } catch (error) {
      throw new Error(
        `Failed to find PalestineAccidentReport by customer ID: ${error.message}`
      );
    }
  }
  ...
  async findByPlateNumber(plateNumber) {
    try {
      ...
      throw new Error(
        `Failed to find PalestineAccidentReport by plate number: ${error.message}`
      );
    }
  }
  ...
  async findAll() {
    try {
      ...
      throw new Error(
        `Failed to find all PalestineAccidentReports: ${error.message}`
      );
    }
  }
  ...
  async update(id, palestineAccidentReport) {
    try {
      ...
      const mongooseDoc = await PalestineAccidentReportModel.findByIdAndUpdate(
        id,
        accidentData,
        { new: true }
      );
      ...
      throw new Error(
        `Failed to update PalestineAccidentReport: ${error.message}`
      );
    }
  }
  ...
  async delete(id) {
    try {
      const mongooseDoc = await PalestineAccidentReportModel.findByIdAndDelete(
        id
      );
      return this.mapToPalestineAccidentReportEntity(mongooseDoc);
    } catch (error) {
      throw new Error(
        `Failed to delete PalestineAccidentReport: ${error.message}`
      );
    }
  }
  ...
  async getStats() {
    try {
      ...
      const reportsThisMonth =
        await PalestineAccidentReportModel.countDocuments({
          createdAt: {
      ...
      throw new Error(
        `Failed to get PalestineAccidentReport stats: ${error.message}`
      );
    }
  }
  ...
  async countAccidentReports() {
    try {
      ...
      throw new Error(
        `Failed to count PalestineAccidentReport reports: ${error.message}`
      );
    }
  }
  ...
  async findByDateRange(startDate, endDate) {
    try {
      ...
      throw new Error(
        `Failed to find PalestineAccidentReport by date range: ${error.message}`
      );
    }
  }
  ...
  async findByAccidentType(accidentType) {
    try {
      ...
      throw new Error(
        `Failed to find PalestineAccidentReport by accident type: ${error.message}`
      );
    }
  }
}
