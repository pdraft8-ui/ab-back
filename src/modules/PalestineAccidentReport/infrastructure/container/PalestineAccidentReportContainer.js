...
export class PalestineAccidentReportContainer {
  ...
  initializeDependencies() {
    ...
    this.dependencies.set(
      ...
      new MongoPalestineAccidentReportRepository()
    );
    ...
    this.dependencies.set(
      ...
      new CreatePalestineAccidentReportUseCase({
        palestineAccidentReportRepository: this.dependencies.get(
          "palestineAccidentReportRepository"
        ),
    ...
    this.dependencies.set(
      ...
      new GetAllPalestineAccidentReportsUseCase({
        palestineAccidentReportRepository: this.dependencies.get(
          "palestineAccidentReportRepository"
        ),
      })
    ...
    this.dependencies.set(
      ...
      new GetPalestineAccidentReportByIdUseCase({
        palestineAccidentReportRepository: this.dependencies.get(
          "palestineAccidentReportRepository"
        ),
      })
    ...
    this.dependencies.set(
      ...
      new DeletePalestineAccidentReportUseCase({
        palestineAccidentReportRepository: this.dependencies.get(
          "palestineAccidentReportRepository"
        ),
        auditService: this.dependencies.get("auditService"),
    ...
    this.dependencies.set(
      ...
      new GetPalestineAccidentReportStatsUseCase({
        palestineAccidentReportRepository: this.dependencies.get(
          "palestineAccidentReportRepository"
        ),
      })
    ...
    // Presentation Layer
    this.dependencies.set(
      "palestineAccidentReportController",
      new PalestineAccidentReportController({
        createPalestineAccidentReportUseCase: this.dependencies.get(
          "createPalestineAccidentReportUseCase"
        ),
        getAllPalestineAccidentReportsUseCase: this.dependencies.get(
          "getAllPalestineAccidentReportsUseCase"
        ),
        getPalestineAccidentReportByIdUseCase: this.dependencies.get(
          "getPalestineAccidentReportByIdUseCase"
        ),
        deletePalestineAccidentReportUseCase: this.dependencies.get(
          "deletePalestineAccidentReportUseCase"
        ),
        getPalestineAccidentReportStatsUseCase: this.dependencies.get(
          "getPalestineAccidentReportStatsUseCase"
        ),
      })
    );
    ...
    this.dependencies.set(
      "palestineAccidentReportRoutes",
      new PalestineAccidentReportRoutes({
        palestineAccidentReportController: this.dependencies.get(
          "palestineAccidentReportController"
        ),
      })
    );
