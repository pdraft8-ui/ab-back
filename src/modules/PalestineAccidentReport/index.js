...
export {
  PalestineAccidentReportContainer,
  PalestineAccidentReportContainerMinimal,
} from "./infrastructure/container/PalestineAccidentReportContainer.js";

// Route factory function
export async function getPalestineAccidentReportRoutes() {
  const { PalestineAccidentReportContainer } = await import(
    "./infrastructure/container/PalestineAccidentReportContainer.js"
  );
...
export async function getPalestineAccidentReportContainerMinimal() {
  const { PalestineAccidentReportContainerMinimal } = await import(
    "./infrastructure/container/PalestineAccidentReportContainer.js"
  );
