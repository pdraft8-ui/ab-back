export class PalestineAccidentReport {
  ...
  isValidAgentInfo() {
    if (!this.agentInfo) return true;
    const { agentName, documentNumber, documentType, insurancePeriod } =
      this.agentInfo;
  ...
  isValidDriverInfo() {
    ...
    const { name, idNumber, age, occupation, license, address } =
      this.driverInfo;
  ...
  isValidThirdParty() {
    if (!this.thirdParty) return true;
    const {
      vehicleNumber,
      vehicleType,
      make,
  ...
  isValidInjuries() {
    if (!Array.isArray(this.injuries)) return false;
  ...
  isValidWitnesses() {
    if (!Array.isArray(this.witnesses)) return false;
  ...
  isValidPassengers() {
    if (!Array.isArray(this.passengers)) return false;
  ...
  isValidAdditionalDetails() {
    if (!this.additionalDetails) return true;
