export class PalestineAccidentReportController {
  ...
  async addAccidentReport(req, res) {
    try {
      ...
      const accidentReport =
        await this.createPalestineAccidentReportUseCase.execute(
          accidentData,
          plateNumber,
          userId,
          userName
  ...
  async getAllAccidentReports(req, res) {
    try {
      const accidentReports =
        await this.getAllPalestineAccidentReportsUseCase.execute();
  ...
  async findById(req, res) {
    try {
      ...
      const accidentReport =
        await this.getPalestineAccidentReportByIdUseCase.execute(id);
  ...
  async deleteAccidentReport(req, res) {
    try {
      ...
      const result = await this.deletePalestineAccidentReportUseCase.execute(
        id,
        userId,
        userName
      );
