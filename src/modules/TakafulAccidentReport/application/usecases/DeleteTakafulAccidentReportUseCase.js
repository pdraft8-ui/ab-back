  ...
  async execute(id, userId, userName) {
    try {
      ...
      const deletedAccidentReport =
        await this.takafulAccidentReportRepository.delete(id);
      ...
      await this.auditService.logAction(
        "DELETE_TAKAFUL_ACCIDENT_REPORT",
        `Deleted takaful accident report: ${
          existingAccidentReport.accidentInfo?.accidentType || "Unknown"
        }`,
        userId,
        userName,
        existingAccidentReport,
        null
      );
