...
export class MongoTakafulAccidentReportRepository extends ITakafulAccidentReportRepository {
  async create(accidentReportData) {
    try {
      ...
      console.error(
        "MongoTakafulAccidentReportRepository create error:",
        error
      );
      throw error;
    }
  ...
  async findById(id) {
    try {
      ...
      console.error(
        "MongoTakafulAccidentReportRepository findById error:",
        error
      );
      throw error;
    }
  ...
  async findByCustomerId(customerId) {
    try {
      ...
      return accidentReports.map((report) =>
        this.mapToTakafulAccidentReportEntity(report)
      );
    } catch (error) {
      console.error(
        "MongoTakafulAccidentReportRepository findByCustomerId error:",
        error
      );
      throw error;
    }
  ...
  async findByPlateNumber(plateNumber) {
    try {
      ...
      console.error(
        "MongoTakafulAccidentReportRepository findByPlateNumber error:",
        error
      );
      throw error;
    }
  ...
  async findAll() {
    try {
      ...
      console.error(
        "MongoTakafulAccidentReportRepository findAll error:",
        error
      );
      throw error;
    }
  ...
  async update(id, accidentReportData) {
    try {
      const updatedAccidentReport =
        await TakafulAccidentReportModel.findByIdAndUpdate(
          id,
          accidentReportData,
          { new: true }
        );
      ...
      console.error(
        "MongoTakafulAccidentReportRepository update error:",
        error
      );
      throw error;
    }
  ...
  async delete(id) {
    try {
      const deletedAccidentReport =
        await TakafulAccidentReportModel.findByIdAndDelete(id);
      return deletedAccidentReport
        ? this.mapToTakafulAccidentReportEntity(deletedAccidentReport)
        : null;
    } catch (error) {
      console.error(
        "MongoTakafulAccidentReportRepository delete error:",
        error
      );
      throw error;
    }
  ...
  async getStats() {
    try {
      ...
      const reportsWithWitnesses =
        await TakafulAccidentReportModel.countDocuments({
          "policeAndWitnesses.witnesses.0": { $exists: true },
        });

      const reportsWithPassengers =
        await TakafulAccidentReportModel.countDocuments({
      ...
      return {
        ...
        averageReportsPerDay:
          totalReports > 0 ? Math.round(totalReports / 365) : 0,
      };
    } catch (error) {
      console.error(
        "MongoTakafulAccidentReportRepository getStats error:",
        error
      );
      throw error;
    }
  ...
  async countAccidentReports() {
    try {
      ...
      console.error(
        "MongoTakafulAccidentReportRepository countAccidentReports error:",
        error
      );
      throw error;
    }
  ...
  async findByDateRange(startDate, endDate) {
    try {
      ...
      console.error(
        "MongoTakafulAccidentReportRepository findByDateRange error:",
        error
      );
      throw error;
    }
  ...
  async findByAccidentType(accidentType) {
    try {
      ...
      console.error(
        "MongoTakafulAccidentReportRepository findByAccidentType error:",
        error
      );
      throw error;
    }
