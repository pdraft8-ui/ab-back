...
export class TakafulAccidentReportContainer {
  ...
  initializeDependencies() {
    ...
    this.createTakafulAccidentReportUseCase =
      new CreateTakafulAccidentReportUseCase(
        this.takafulAccidentReportRepository,
        this.customerRepository,
        this.auditService,
        this.notificationService
    ...
    this.getAllTakafulAccidentReportsUseCase =
      new GetAllTakafulAccidentReportsUseCase(
        this.takafulAccidentReportRepository
      );
    this.getTakafulAccidentReportByIdUseCase =
      new GetTakafulAccidentReportByIdUseCase(
        this.takafulAccidentReportRepository
      );
    this.deleteTakafulAccidentReportUseCase =
      new DeleteTakafulAccidentReportUseCase(
        this.takafulAccidentReportRepository,
        this.auditService,
        this.notificationService
      );
    this.getTakafulAccidentReportStatsUseCase =
      new GetTakafulAccidentReportStatsUseCase(
        this.takafulAccidentReportRepository
      );

    // Presentation
    this.takafulAccidentReportController = new TakafulAccidentReportController(
      this.createTakafulAccidentReportUseCase,
      this.getAllTakafulAccidentReportsUseCase,
      this.getTakafulAccidentReportByIdUseCase,
      this.deleteTakafulAccidentReportUseCase,
    ...
    this.takafulAccidentReportRoutes = new TakafulAccidentReportRoutes(
...
export class TakafulAccidentReportContainerMinimal {
  constructor() {
    this.mockTakafulAccidentReportRepository = {
      create: async (data) =>
        new TakafulAccidentReport({ id: "mock-id", ...data }),
      findById: async (id) =>
