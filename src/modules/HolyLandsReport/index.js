...
export {
  HolyLandsReportContainer,
  HolyLandsReportContainerMinimal,
} from "./infrastructure/container/HolyLandsReportContainer.js";

// Route factory function
export async function getHolyLandsReportRoutes() {
  const { HolyLandsReportContainer } = await import(
    "./infrastructure/container/HolyLandsReportContainer.js"
  );
...
export async function getHolyLandsReportContainerMinimal() {
  const { HolyLandsReportContainerMinimal } = await import(
    "./infrastructure/container/HolyLandsReportContainer.js"
  );
