  ...
  try {
    ...
    if (!vehicle) {
      return res.status(404).json({
        message: "Vehicle not found for this customer person",
      });
    }
    ...
    const newReport = new HoliAccidentReportModel({
      ...
      ownerAndDriverDetails: {
        ...
        driverLicenseNumber:
          req.body.ownerAndDriverDetails?.driverLicenseNumber || "",
        driverLicenseGrade:
          req.body.ownerAndDriverDetails?.driverLicenseGrade || "",
        licenseIssueDate:
          req.body.ownerAndDriverDetails?.licenseIssueDate || null,
        ...
        driverProfession:
          req.body.ownerAndDriverDetails?.driverProfession || "",
        licenseIssuePlace:
          req.body.ownerAndDriverDetails?.licenseIssuePlace || "",
      },
...
export const getAllReports = async (req, res, next) => {
  try {
    const allReports = await HoliAccidentReportModel.find();
    return res.status(200).json({
      success: true,
