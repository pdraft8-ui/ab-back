...
export class MongoHolyLandsReportRepository extends IHolyLandsReportRepository {
  ...
  async findByCustomerId(customerId) {
    try {
      ...
      throw new Error(
        `Failed to find HolyLandsReport by customer ID: ${error.message}`
      );
    }
  }
  ...
  async findByPlateNumber(plateNumber) {
    try {
      ...
      throw new Error(
        `Failed to find HolyLandsReport by plate number: ${error.message}`
      );
    }
  }
  ...
  async update(id, holyLandsReport) {
    try {
      ...
      const mongooseDoc = await HoliAccidentReportModel.findByIdAndUpdate(
        id,
        accidentData,
        { new: true }
      );
  ...
  async countAccidentReports() {
    try {
      ...
      throw new Error(
        `Failed to count HolyLandsReport reports: ${error.message}`
      );
    }
  }
  ...
  async findByDateRange(startDate, endDate) {
    try {
      ...
      throw new Error(
        `Failed to find HolyLandsReport by date range: ${error.message}`
      );
    }
  }
  ...
  async findByAccidentType(accidentType) {
    try {
      ...
      throw new Error(
        `Failed to find HolyLandsReport by accident type: ${error.message}`
      );
    }
  }
}
