...
export const updateDocumentSettings = async (req, res, next) => {
  try {
    ...
    // Update fields
    if (companyName !== undefined) settings.header.companyName = companyName;
    if (companyAddress !== undefined)
      settings.header.companyAddress = companyAddress;
    if (companyPhone !== undefined) settings.header.companyPhone = companyPhone;
    if (companyEmail !== undefined) settings.header.companyEmail = companyEmail;
    if (companyWebsite !== undefined)
      settings.header.companyWebsite = companyWebsite;
    if (footerText !== undefined) settings.footer.footerText = footerText;
