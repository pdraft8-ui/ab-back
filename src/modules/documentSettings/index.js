...
} from "./infrastructure/container/DocumentSettingsContainer.js";

// Export route factory
export const getDocumentSettingsRoutes = async () => {
  const { DocumentSettingsContainer } = await import(
    "./infrastructure/container/DocumentSettingsContainer.js"
  );
