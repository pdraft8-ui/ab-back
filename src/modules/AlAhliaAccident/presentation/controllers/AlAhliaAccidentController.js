export class AlAhliaAccidentController {
  ...
  async addAccidentReport(req, res) {
    try {
      ...
      const accidentReport = await this.createAlAhliaAccidentUseCase.execute(
        accidentData,
        plateNumber,
        userId,
        userName
  ...
  async getAllAccidentReports(req, res) {
    try {
      const accidentReports =
        await this.getAllAlAhliaAccidentsUseCase.execute();
  ...
  async findById(req, res) {
    try {
      ...
      const accidentReport = await this.getAlAhliaAccidentByIdUseCase.execute(
        id
      );
  ...
  async deleteAccidentReport(req, res) {
    try {
      ...
      const result = await this.deleteAlAhliaAccidentUseCase.execute(
        id,
        userId,
        userName
      );
