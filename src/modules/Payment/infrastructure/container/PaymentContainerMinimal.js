...
export class PaymentContainerMinimal {
  ...
  initializeServices() {
    ...
    this.services.set(
      ...
      new GetAllPaymentsUseCase(this.get("paymentRepository"))
    );
    ...
    this.services.set(
      ...
      new PaymentController(
        this.get("createPaymentUseCase"),
        this.get("getAllPaymentsUseCase"),
        this.get("refundPaymentUseCase"),
        this.get("paymentRepository")
      )
    );
    ...
    this.services.set(
      "paymentRoutes",
      new PaymentRoutes(this.get("paymentController"))
    );
  }
