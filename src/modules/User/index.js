...
export {
  UserContainer,
  UserContainerMinimal,
} from "./infrastructure/container/UserContainer.js";
...
export async function getUserRoutes() {
  const { UserContainer } = await import(
    "./infrastructure/container/UserContainer.js"
  );
...
export async function getUserContainerMinimal() {
  const { UserContainerMinimal } = await import(
    "./infrastructure/container/UserContainer.js"
  );
