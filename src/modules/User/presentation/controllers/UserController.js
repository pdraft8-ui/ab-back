export class UserController {
  ...
  async sendCode(req, res) {
    try {
      ...
      const result =
        await this.updateUserUseCase.userService.sendVerificationCode(email);
  ...
  async forgetPassword(req, res) {
    try {
      ...
      const result = await this.updateUserUseCase.userService.resetPassword(
        email
      );
  ...
  async addHeadOfDepartmentToDepartment(req, res) {
    try {
      ...
      const result =
        await this.updateUserUseCase.userService.addHeadOfDepartmentToDepartment(
          userId,
          departmentId
        );
  ...
  async removeHeadOfDepartmentFromDepartment(req, res) {
    try {
      ...
      const result =
        await this.updateUserUseCase.userService.removeHeadOfDepartmentFromDepartment(
          userId,
          depId
        );
  ...
  async getHeadOfDepartment(req, res) {
    try {
      ...
      const headOfDepartment =
        await this.updateUserUseCase.userService.getHeadOfDepartment(
          departmentId
        );
  ...
  async addEmployee(req, res) {
    try {
      ...
      const employee = await this.addEmployeeToDepartmentUseCase.execute(
        employeeData,
        departmentId
      );
  ...
  async removeEmployee(req, res) {
    try {
      ...
      const result =
        await this.updateUserUseCase.userService.removeEmployeeFromDepartment(
          employeeId,
          depId
        );
  ...
  async getAllEmployees(req, res) {
    try {
      ...
      const employees = await this.getEmployeesByDepartmentUseCase.execute(
        departmentId
      );
  ...
  async updateEmployee(req, res) {
    try {
      ...
      const updatedEmployee = await this.updateUserUseCase.execute(
        employeeId,
        updateData
      );
  ...
  async sendCustomEmail(req, res) {
    try {
      ...
      const result = await this.updateUserUseCase.userService.sendEmail(
        to,
        subject,
        content
      );
  ...
  async sendBulkEmails(req, res) {
    try {
      ...
      const result = await this.updateUserUseCase.userService.sendBulkEmails(
        recipients,
        subject,
        content
      );
  ...
  async getInboxEmails(req, res) {
    try {
      ...
      const result = await this.updateUserUseCase.userService.getInboxEmails(
        userId,
        filters
      );
  ...
  async getEmailById(req, res) {
    try {
      ...
      const result = await this.updateUserUseCase.userService.getEmailById(
        userId,
        uid
      );
  ...
  async markEmailReadStatus(req, res) {
    try {
      ...
      const result = await this.updateUserUseCase.userService.markEmailAsRead(
        userId,
        uid,
        isRead
      );
  ...
  async deleteEmail(req, res) {
    try {
      ...
      const result = await this.updateUserUseCase.userService.deleteEmail(
        userId,
        uid
      );
  ...
  async getInboxStats(req, res) {
    try {
      ...
      const stats = await this.updateUserUseCase.userService.getInboxStats(
        userId
      );
