export class AlMashreqAccidentReport {
  ...
  isValidInsurancePolicy() {
    if (!this.insurancePolicy) return true;
  ...
  isValidAccident() {
    ...
    if (
      vehicleUsedPermission !== undefined &&
  ...
  isValidPersonalInjuries() {
    if (!Array.isArray(this.personalInjuries)) return false;
  ...
  isValidDriverSignature() {
    if (!this.driverSignature) return true;
