...
export class MongoAlMashreqAccidentReportRepository extends IAlMashreqAccidentReportRepository {
  ...
  async create(alMashreqAccidentReport) {
    try {
      ...
      const mongooseDoc = await AlMashreqAccidentReportModel.create(
        accidentData
      );
      return this.mapToAlMashreqAccidentReportEntity(mongooseDoc);
    } catch (error) {
      throw new Error(
        `Failed to create AlMashreqAccidentReport: ${error.message}`
      );
    }
  }
  ...
  async findById(id) {
    try {
      ...
      throw new Error(
        `Failed to find AlMashreqAccidentReport by ID: ${error.message}`
      );
    }
  }
  ...
  async findByCustomerId(customerId) {
    try {
      ...
      return mongooseDocs.map((doc) =>
        this.mapToAlMashreqAccidentReportEntity(doc)
      );
    } catch (error) {
      throw new Error(
        `Failed to find AlMashreqAccidentReport by customer ID: ${error.message}`
      );
    }
  }
  ...
  async findByPlateNumber(plateNumber) {
    try {
      ...
      throw new Error(
        `Failed to find AlMashreqAccidentReport by plate number: ${error.message}`
      );
    }
  }
  ...
  async findAll() {
    try {
      ...
      throw new Error(
        `Failed to find all AlMashreqAccidentReports: ${error.message}`
      );
    }
  }
  ...
  async update(id, alMashreqAccidentReport) {
    try {
      ...
      const mongooseDoc = await AlMashreqAccidentReportModel.findByIdAndUpdate(
        id,
        accidentData,
        { new: true }
      );
      ...
      throw new Error(
        `Failed to update AlMashreqAccidentReport: ${error.message}`
      );
    }
  }
  ...
  async delete(id) {
    try {
      const mongooseDoc = await AlMashreqAccidentReportModel.findByIdAndDelete(
        id
      );
      return this.mapToAlMashreqAccidentReportEntity(mongooseDoc);
    } catch (error) {
      throw new Error(
        `Failed to delete AlMashreqAccidentReport: ${error.message}`
      );
    }
  }
  ...
  async getStats() {
    try {
      ...
      const reportsThisMonth =
        await AlMashreqAccidentReportModel.countDocuments({
          createdAt: {
      ...
      throw new Error(
        `Failed to get AlMashreqAccidentReport stats: ${error.message}`
      );
    }
  }
  ...
  async countAccidentReports() {
    try {
      ...
      throw new Error(
        `Failed to count AlMashreqAccidentReport reports: ${error.message}`
      );
    }
  }
  ...
  async findByDateRange(startDate, endDate) {
    try {
      ...
      throw new Error(
        `Failed to find AlMashreqAccidentReport by date range: ${error.message}`
      );
    }
  }
  ...
  async findByAccidentType(accidentType) {
    try {
      ...
      throw new Error(
        `Failed to find AlMashreqAccidentReport by accident type: ${error.message}`
      );
    }
  }
}
