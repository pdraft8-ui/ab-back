...
export {
  AlMashreqAccidentReportContainer,
  AlMashreqAccidentReportContainerMinimal,
} from "./infrastructure/container/AlMashreqAccidentReportContainer.js";

// Route factory function
export async function getAlMashreqAccidentReportRoutes() {
  const { AlMashreqAccidentReportContainer } = await import(
    "./infrastructure/container/AlMashreqAccidentReportContainer.js"
  );
...
export async function getAlMashreqAccidentReportContainerMinimal() {
  const { AlMashreqAccidentReportContainerMinimal } = await import(
    "./infrastructure/container/AlMashreqAccidentReportContainer.js"
  );
