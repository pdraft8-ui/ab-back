...
export class VehicleRoutes {
  ...
  setupRoutes() {
    ...
    this.router.post(
      ...
      this.vehicleController.addVehicle.bind(this.vehicleController)
    );
    ...
    this.router.get(
      ...
      this.vehicleController.getAllVehicles.bind(this.vehicleController)
    );

    this.router.get(
      "/findVehicle/:id",
      auth(endPoints.findVehicleById),
      this.vehicleController.getVehicleById.bind(this.vehicleController)
    );

    this.router.get(
      "/getVehiclesByCustomer/:customerId",
      auth(endPoints.getVehiclesByCustomer),
      this.vehicleController.getVehiclesByCustomer.bind(this.vehicleController)
    );
    ...
    this.router.post(
      ...
      this.vehicleController.addInsuranceToVehicle.bind(this.vehicleController)
    );
    ...
    this.router.get(
      "/stats",
      auth(endPoints.allVehicles),
      this.vehicleController.getVehicleStats.bind(this.vehicleController)
    );
  }
