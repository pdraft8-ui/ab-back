...
} from "./infrastructure/container/VehicleContainer.js";

// Export route factory
export const getVehicleRoutes = async () => {
  const { VehicleContainer } = await import(
    "./infrastructure/container/VehicleContainer.js"
  );
  const container = new VehicleContainer();
  return container.getVehicleRoutes();
};
