...
export class NotificationContainer {
  ...
  initializeServices() {
    ...
    this.services.set(
      ...
      new SendNotificationUseCase(this.services.get("notificationService"))
    );

    this.services.set(
      "getNotificationsUseCase",
      new GetNotificationsUseCase(this.services.get("notificationService"))
    );

    this.services.set(
      "markAsReadUseCase",
      new MarkAsReadUseCase(this.services.get("notificationService"))
    );

    this.services.set(
      "markAllAsReadUseCase",
      new MarkAllAsReadUseCase(this.services.get("notificationService"))
    );

    this.services.set(
      "getNotificationStatsUseCase",
      new GetNotificationStatsUseCase(this.services.get("notificationService"))
    );
    ...
    this.services.set(
      ...
      new NotificationController(
        this.services.get("sendNotificationUseCase"),
        this.services.get("getNotificationsUseCase"),
        this.services.get("markAsReadUseCase"),
        this.services.get("markAllAsReadUseCase"),
    ...
    this.services.set(
      "notificationRoutes",
      new NotificationRoutes(this.services.get("notificationController"))
    );
  }
