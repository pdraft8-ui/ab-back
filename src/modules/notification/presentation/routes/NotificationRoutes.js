...
export class NotificationRoutes {
  ...
  setupRoutes() {
    ...
    this.router.post(
      ...
      this.notificationController.sendNotification.bind(
    ...
    this.router.get(
      "/:id",
      auth(["admin", "manager", "employee"]),
      this.notificationController.getNotificationById.bind(
        this.notificationController
      )
    );
    ...
    this.router.delete(
      "/:notificationId",
      auth(["admin", "manager", "employee"]),
      this.notificationController.deleteNotification.bind(
        this.notificationController
      )
    );
    ...
    this.router.get(
      "/stats/overview",
      auth(["admin", "manager", "employee"]),
      this.notificationController.getNotificationStats.bind(
        this.notificationController
      )
    );
  }
