...
export class InsuranceCompanyRoutes {
  ...
  setupRoutes() {
    ...
    this.router.post(
      ...
      this.insuranceCompanyController.addInsuranceCompany.bind(
    ...
    this.router.get(
      ...
      this.insuranceCompanyController.getAllInsuranceCompanies.bind(
        this.insuranceCompanyController
      )
    );
    ...
    this.router.get(
      "/:id",
      auth(endPoints.allCompany),
      this.insuranceCompanyController.getInsuranceCompanyById.bind(
        this.insuranceCompanyController
      )
    );
    ...
    this.router.patch(
      ...
      this.insuranceCompanyController.updateInsuranceCompany.bind(
        this.insuranceCompanyController
      )
    );
    ...
    this.router.delete(
      ...
      this.insuranceCompanyController.deleteInsuranceCompany.bind(
        this.insuranceCompanyController
      )
    );
    ...
    this.router.get(
      "/stats/overview",
      auth(endPoints.allCompany),
      this.insuranceCompanyController.getInsuranceCompanyStats.bind(
        this.insuranceCompanyController
      )
    );
  }
