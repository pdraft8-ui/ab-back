export class InsuranceCompanyController {
  constructor(
    createInsuranceCompanyUseCase,
    getAllInsuranceCompaniesUseCase,
    getInsuranceCompanyByIdUseCase,
    updateInsuranceCompanyUseCase,
    deleteInsuranceCompanyUseCase,
    getInsuranceCompanyStatsUseCase
  ) {
  ...
  async addInsuranceCompany(req, res, next) {
    try {
      ...
      const company = await this.createInsuranceCompanyUseCase.execute(
        companyData,
        userId,
        userName
      );
  ...
  async updateInsuranceCompany(req, res, next) {
    try {
      ...
      const company = await this.updateInsuranceCompanyUseCase.execute(
        id,
        updateData,
        userId,
        userName
  ...
  async deleteInsuranceCompany(req, res, next) {
    try {
      ...
      const result = await this.deleteInsuranceCompanyUseCase.execute(
        id,
        userId,
        userName
      );
