...
export class AuditContainer {
  ...
  initializeServices() {
    ...
    this.services.set(
      "logActionUseCase",
      new LogActionUseCase(this.services.get("auditService"))
    );

    this.services.set(
      "getAuditLogsUseCase",
      new GetAuditLogsUseCase(this.services.get("auditService"))
    );

    this.services.set(
      "getAuditLogByIdUseCase",
      new GetAuditLogByIdUseCase(this.services.get("auditService"))
    );

    this.services.set(
      "getAuditStatsUseCase",
      new GetAuditStatsUseCase(this.services.get("auditService"))
    );
    ...
    this.services.set(
      "auditController",
      new AuditController(
        this.services.get("logActionUseCase"),
        this.services.get("getAuditLogsUseCase"),
        this.services.get("getAuditLogByIdUseCase"),
        this.services.get("getAuditStatsUseCase")
      )
    );
    ...
    this.services.set(
      "auditRoutes",
      new AuditRoutes(this.services.get("auditController"))
    );
  }
