...
export class CustomerContainer {
  ...
  initializeServices() {
    ...
    this.services.set(
      ...
      new GetAllCustomersUseCase(this.get("customerRepository"))
    );
    ...
    this.services.set(
      ...
      new GetCustomerStatsUseCase(this.get("customerRepository"))
    );
    ...
    this.services.set(
      ...
      new CustomerController(
        this.get("createCustomerUseCase"),
        this.get("getAllCustomersUseCase"),
        this.get("updateCustomerUseCase"),
        this.get("deleteCustomerUseCase"),
        this.get("addVehicleToCustomerUseCase"),
        this.get("getCustomerStatsUseCase"),
        this.get("customerRepository")
      )
    );
    ...
    this.services.set(
      "customerRoutes",
      new CustomerRoutes(this.get("customerController"))
    );
  }
