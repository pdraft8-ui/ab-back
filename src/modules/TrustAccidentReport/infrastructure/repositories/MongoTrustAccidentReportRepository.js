...
export class MongoTrustAccidentReportRepository {
  ...
  async create(trustAccidentReport) {
    try {
      ...
      throw new Error(
        `Failed to create trust accident report: ${error.message}`
      );
    }
  }
  ...
  async findById(id) {
    try {
      ...
      throw new Error(
        `Failed to find trust accident report by ID: ${error.message}`
      );
    }
  }
  ...
  async findByCustomerId(customerId) {
    try {
      ...
      return reports.map((report) =>
        this.mapToTrustAccidentReportEntity(report)
      );
    } catch (error) {
      throw new Error(
        `Failed to find trust accident reports by customer ID: ${error.message}`
      );
    }
  }
  ...
  async findByPlateNumber(plateNumber) {
    try {
      ...
      throw new Error(
        `Failed to find trust accident reports by plate number: ${error.message}`
      );
    }
  }
  ...
  async findAll() {
    try {
      ...
      throw new Error(
        `Failed to find all trust accident reports: ${error.message}`
      );
    }
  }
  ...
  async update(id, trustAccidentReport) {
    try {
      ...
      const updatedReport = await TrustAccidentReportModel.findByIdAndUpdate(
        id,
      ...
      throw new Error(
        `Failed to update trust accident report: ${error.message}`
      );
    }
  }
  ...
  async delete(id) {
    try {
      const deletedReport = await TrustAccidentReportModel.findByIdAndDelete(
        id
      );
      ...
      throw new Error(
        `Failed to delete trust accident report: ${error.message}`
      );
    }
  }
  ...
  async getStats() {
    try {
      ...
      throw new Error(
        `Failed to get trust accident report stats: ${error.message}`
      );
    }
  }
  ...
  async countAccidentReports() {
    try {
      ...
      throw new Error(
        `Failed to count trust accident reports: ${error.message}`
      );
    }
  }
  ...
  async findByDateRange(startDate, endDate) {
    try {
      ...
      throw new Error(
        `Failed to find trust accident reports by date range: ${error.message}`
      );
    }
  }
  ...
  async findByAccidentType(accidentType) {
    try {
      ...
      throw new Error(
        `Failed to find trust accident reports by accident type: ${error.message}`
      );
    }
  }
}
