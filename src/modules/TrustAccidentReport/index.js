...
export {
  TrustAccidentReportContainer,
  TrustAccidentReportContainerMinimal,
} from "./infrastructure/container/TrustAccidentReportContainer.js";

// Export container instances
export const getTrustAccidentReportContainer = async () => {
  const { TrustAccidentReportContainer } = await import(
    "./infrastructure/container/TrustAccidentReportContainer.js"
  );
  return new TrustAccidentReportContainer();
};

export const getTrustAccidentReportContainerMinimal = async () => {
  const { TrustAccidentReportContainerMinimal } = await import(
    "./infrastructure/container/TrustAccidentReportContainer.js"
  );
