  ...
  initializeServices() {
    ...
    this.services.set(
      ...
      new CreatePaymentUseCase(
        ...
        this.services.get("customerRepository"),
        this.services.get("notificationService"),
        this.services.get("auditService")
      )
    );

    this.services.set(
      "getAllPaymentsUseCase",
      new GetAllPaymentsUseCase(this.services.get("paymentRepository"))
    );
    ...
    this.services.set(
      ...
      new GetAllInvoicesUseCase(this.services.get("invoiceRepository"))
    );
    ...
    this.services.set(
      ...
      new GetInvoiceStatsUseCase(this.services.get("invoiceRepository"))
    );
    ...
    this.services.set(
      ...
      new GetAllCustomersUseCase(this.services.get("customerRepository"))
    );
    ...
    this.services.set(
      ...
      new AddVehicleToCustomerUseCase(
        this.services.get("customerRepository"),
        this.services.get("auditService")
      )
    );
    ...
    this.services.set(
      ...
      new GetCustomerStatsUseCase(this.services.get("customerRepository"))
    );
    ...
    this.services.set(
      ...
      new PaymentController(
        this.services.get("createPaymentUseCase"),
        this.services.get("getAllPaymentsUseCase"),
        this.services.get("refundPaymentUseCase"),
        this.services.get("paymentRepository")
      )
    );
    ...
    this.services.set(
      ...
      new InvoiceController(
        this.services.get("createInvoiceUseCase"),
        this.services.get("getAllInvoicesUseCase"),
        this.services.get("updateInvoiceUseCase"),
        this.services.get("getInvoiceStatsUseCase"),
        this.services.get("markOverdueInvoicesUseCase"),
        this.services.get("invoiceRepository")
      )
    );
    ...
    this.services.set(
      ...
      new CustomerController(
        this.services.get("createCustomerUseCase"),
        this.services.get("getAllCustomersUseCase"),
        this.services.get("updateCustomerUseCase"),
        this.services.get("deleteCustomerUseCase"),
        this.services.get("addVehicleToCustomerUseCase"),
        this.services.get("getCustomerStatsUseCase"),
        this.services.get("customerRepository")
      )
    );
  }
