...
export class CustomerController {
  ...
  async removeVehicleFromCustomer(req, res, next) {
    try {
      ...
      const customer = await this.customerRepository.removeVehicleFromCustomer(
        customerId,
        vehicleId
      );
  ...
  async updateVehicle(req, res, next) {
    try {
      const { customerId, vehicleId } = req.params;
      const updateData = req.body;
      const customer = await this.customerRepository.updateVehicle(
        customerId,
        vehicleId,
        updateData
      );
  ...
  async addInsuranceToVehicle(req, res, next) {
    try {
      ...
      const customer = await this.customerRepository.addInsuranceToVehicle(
        customerId,
        vehicleId,
        insuranceData
      );
  ...
  async removeInsuranceFromVehicle(req, res, next) {
    try {
      ...
      const customer = await this.customerRepository.removeInsuranceFromVehicle(
        customerId,
        vehicleId,
        insuranceId
      );
  ...
  async getVehicleInsurances(req, res, next) {
    try {
      const { customerId, vehicleId } = req.params;
      const insurances = await this.customerRepository.getVehicleInsurances(
        customerId,
        vehicleId
      );
  ...
  async getAllVehicleInsurances(req, res, next) {
    try {
      const insurances =
        await this.customerRepository.getAllVehicleInsurances();
  ...
  async getAllInsurancesData(req, res, next) {
    try {
      const insurancesData =
        await this.customerRepository.getAllInsurancesData();
  ...
  async addCustomerInsurance(req, res, next) {
    try {
      const { customerId } = req.params;
      const insuranceData = req.body;
      const customer = await this.customerRepository.addCustomerInsurance(
        customerId,
        insuranceData
      );
  ...
  async getCustomerInsurances(req, res, next) {
    try {
      const { customerId } = req.params;
      const insurances = await this.customerRepository.getCustomerInsurances(
        customerId
      );
  ...
  async getAllCustomerInsurances(req, res, next) {
    try {
      const { customerId } = req.params;
      const insurances = await this.customerRepository.getAllCustomerInsurances(
        customerId
      );
  ...
  async getInsuranceById(req, res, next) {
    try {
      ...
      const insurance = await this.customerRepository.getInsuranceById(
        insuranceId
      );
  ...
  async updateInsuranceById(req, res, next) {
    try {
      const { insuranceId } = req.params;
      const updateData = req.body;
      const customer = await this.customerRepository.updateCustomerInsurance(
        null,
        insuranceId,
        updateData
      );
  ...
  async deleteInsuranceById(req, res, next) {
    try {
      const { insuranceId } = req.params;
      const customer = await this.customerRepository.deleteInsuranceById(
        insuranceId
      );
  ...
  async addCheckToInsurance(req, res, next) {
    try {
      ...
      const customer = await this.customerRepository.addCheckToInsurance(
        customerId,
        vehicleId,
        insuranceId,
        checkData
  ...
  async removeCheckFromInsurance(req, res, next) {
    try {
      ...
      const customer = await this.customerRepository.removeCheckFromInsurance(
        customerId,
        vehicleId,
        checkId
      );
  ...
  async getInsuranceChecks(req, res, next) {
    try {
      const { customerId, vehicleId, insuranceId } = req.params;
      const checks = await this.customerRepository.getInsuranceChecks(
        customerId,
        vehicleId,
        insuranceId
      );
  ...
  async getAllChecksForVehicle(req, res, next) {
    try {
      const { customerId, vehicleId } = req.params;
      const checks = await this.customerRepository.getAllChecksForVehicle(
        customerId,
        vehicleId
      );
  ...
  async getCustomerByMonth(req, res, next) {
    try {
      const customersByMonth =
        await this.customerRepository.getCustomersByMonth();
