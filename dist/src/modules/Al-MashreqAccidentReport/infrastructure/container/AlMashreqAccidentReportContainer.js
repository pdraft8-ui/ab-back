...
export class AlMashreqAccidentReportContainer {
    ...
    initializeDependencies() {
        ...
        this.dependencies.set("alMashreqAccidentReportRepository", new MongoAlMashreqAccidentReportRepository());
        ...
        this.dependencies.set("createAlMashreqAccidentReportUseCase", new CreateAlMashreqAccidentReportUseCase({
            alMashreqAccidentReportRepository: this.dependencies.get("alMashreqAccidentReportRepository"),
        ...
        this.dependencies.set("getAllAlMashreqAccidentReportsUseCase", new GetAllAlMashreqAccidentReportsUseCase({
            alMashreqAccidentReportRepository: this.dependencies.get("alMashreqAccidentReportRepository"),
        }));
        this.dependencies.set("getAlMashreqAccidentReportByIdUseCase", new GetAlMashreqAccidentReportByIdUseCase({
            alMashreqAccidentReportRepository: this.dependencies.get("alMashreqAccidentReportRepository"),
        }));
        this.dependencies.set("deleteAlMashreqAccidentReportUseCase", new DeleteAlMashreqAccidentReportUseCase({
            alMashreqAccidentReportRepository: this.dependencies.get("alMashreqAccidentReportRepository"),
            auditService: this.dependencies.get("auditService"),
            notificationService: this.dependencies.get("notificationService"),
        }));
        this.dependencies.set("getAlMashreqAccidentReportStatsUseCase", new GetAlMashreqAccidentReportStatsUseCase({
            alMashreqAccidentReportRepository: this.dependencies.get("alMashreqAccidentReportRepository"),
        }));
        // Presentation Layer
        this.dependencies.set("alMashreqAccidentReportController", new AlMashreqAccidentReportController({
            createAlMashreqAccidentReportUseCase: this.dependencies.get("createAlMashreqAccidentReportUseCase"),
            getAllAlMashreqAccidentReportsUseCase: this.dependencies.get("getAllAlMashreqAccidentReportsUseCase"),
            getAlMashreqAccidentReportByIdUseCase: this.dependencies.get("getAlMashreqAccidentReportByIdUseCase"),
            deleteAlMashreqAccidentReportUseCase: this.dependencies.get("deleteAlMashreqAccidentReportUseCase"),
            getAlMashreqAccidentReportStatsUseCase: this.dependencies.get("getAlMashreqAccidentReportStatsUseCase"),
        }));
        this.dependencies.set("alMashreqAccidentReportRoutes", new AlMashreqAccidentReportRoutes({
            alMashreqAccidentReportController: this.dependencies.get("alMashreqAccidentReportController"),
        }));
    }
    get(dependencyName) {
...
//# sourceMappingURL=AlMashreqAccidentReportContainer.js.map