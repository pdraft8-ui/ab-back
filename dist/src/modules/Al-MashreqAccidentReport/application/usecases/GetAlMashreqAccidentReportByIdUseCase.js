export class GetAlMashreqAccidentReportByIdUseCase {
    ...
    async execute(id) {
        try {
            ...
            const accidentReport = await this.alMashreqAccidentReportRepository.findById(id);
            if (!accidentReport) {
            ...
            throw new Error(`GetAlMashreqAccidentReportByIdUseCase error: ${error.message}`);
        }
    }
}
//# sourceMappingURL=GetAlMashreqAccidentReportByIdUseCase.js.map