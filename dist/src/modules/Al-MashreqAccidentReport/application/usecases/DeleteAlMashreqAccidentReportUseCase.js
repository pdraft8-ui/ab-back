export class DeleteAlMashreqAccidentReportUseCase {
    ...
    async execute(id, userId, userName) {
        try {
            ...
            const existingAccidentReport = await this.alMashreqAccidentReportRepository.findById(id);
            ...
            await this.notificationService.sendNotification({
                ...
                message: `Al-Mashreq accident report for vehicle ${existingAccidentReport.getVehicle().registrationNumber} has been deleted`,
                data: {
            ...
            throw new Error(`DeleteAlMashreqAccidentReportUseCase error: ${error.message}`);
        }
    }
}
//# sourceMappingURL=DeleteAlMashreqAccidentReportUseCase.js.map