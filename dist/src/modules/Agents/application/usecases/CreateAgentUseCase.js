...
export class CreateAgentUseCase {
    ...
    async execute(agentData, userId) {
        try {
            ...
            const existingAgentByEmail = await this.agentRepository.findByEmail(agent.getEmail());
            ...
            const existingAgentByPhone = await this.agentRepository.findByPhone(agent.getPhone());
