...
export class InsuranceCompanyContainer {
    ...
    initializeDependencies() {
        ...
        // Use Cases
        this.createInsuranceCompanyUseCase = new CreateInsuranceCompanyUseCase(this.insuranceCompanyRepository, this.auditService, this.notificationService);
        this.getAllInsuranceCompaniesUseCase = new GetAllInsuranceCompaniesUseCase(this.insuranceCompanyRepository);
        this.getInsuranceCompanyByIdUseCase = new GetInsuranceCompanyByIdUseCase(this.insuranceCompanyRepository);
        this.updateInsuranceCompanyUseCase = new UpdateInsuranceCompanyUseCase(this.insuranceCompanyRepository, this.auditService);
        this.deleteInsuranceCompanyUseCase = new DeleteInsuranceCompanyUseCase(this.insuranceCompanyRepository, this.auditService);
        this.getInsuranceCompanyStatsUseCase = new GetInsuranceCompanyStatsUseCase(this.insuranceCompanyRepository);
        // Presentation
        this.insuranceCompanyController = new InsuranceCompanyController(this.createInsuranceCompanyUseCase, this.getAllInsuranceCompaniesUseCase, this.getInsuranceCompanyByIdUseCase, this.updateInsuranceCompanyUseCase, this.deleteInsuranceCompanyUseCase, this.getInsuranceCompanyStatsUseCase);
        this.insuranceCompanyRoutes = new InsuranceCompanyRoutes(this.insuranceCompanyController);
    }
...
export class InsuranceCompanyContainerMinimal {
    constructor() {
        this.mockInsuranceCompanyRepository = {
            ...
            findById: async (id) => new InsuranceCompany({
                id,
            ...
            addRate: async (id, rateType, rateData) => new InsuranceCompany({ id, rates: { [rateType]: rateData } }),
            updateRate: async (id, rateType, rateData) => new InsuranceCompany({ id, rates: { [rateType]: rateData } }),
            removeRate: async (id, rateType) => new InsuranceCompany({ id, rates: {} }),
            getStats: async () => ({
                totalCompanies: 2,
        ...
        this.createInsuranceCompanyUseCase = new CreateInsuranceCompanyUseCase(this.mockInsuranceCompanyRepository, this.mockAuditService, this.mockNotificationService);
        this.getAllInsuranceCompaniesUseCase = new GetAllInsuranceCompaniesUseCase(this.mockInsuranceCompanyRepository);
        this.getInsuranceCompanyByIdUseCase = new GetInsuranceCompanyByIdUseCase(this.mockInsuranceCompanyRepository);
        this.updateInsuranceCompanyUseCase = new UpdateInsuranceCompanyUseCase(this.mockInsuranceCompanyRepository, this.mockAuditService);
        this.deleteInsuranceCompanyUseCase = new DeleteInsuranceCompanyUseCase(this.mockInsuranceCompanyRepository, this.mockAuditService);
        this.getInsuranceCompanyStatsUseCase = new GetInsuranceCompanyStatsUseCase(this.mockInsuranceCompanyRepository);
...
//# sourceMappingURL=InsuranceCompanyContainer.js.map