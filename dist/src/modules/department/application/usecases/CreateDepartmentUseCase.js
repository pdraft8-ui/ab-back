...
export class CreateDepartmentUseCase {
    ...
    async execute(departmentData) {
        try {
            ...
            const existingDepartment = await this.departmentRepository.findByName(department.name);
            ...
            const createdDepartment = await this.departmentRepository.create(departmentData);
            return {
                success: true,
...
//# sourceMappingURL=CreateDepartmentUseCase.js.map