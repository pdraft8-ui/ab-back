export class Department {
    ...
    addEmployee(employee) {
        if (employee && employee._id) {
            const existingEmployee = this.employees.find((emp) => emp._id.toString() === employee._id.toString());
            if (!existingEmployee) {
                this.employees.push({
                    _id: employee._id,
                    name: employee.name,
    ...
    removeEmployee(employeeId) {
        this.employees = this.employees.filter((emp) => emp._id.toString() !== employeeId.toString());
    }
