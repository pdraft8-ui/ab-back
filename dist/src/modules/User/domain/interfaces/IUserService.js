export class IUserService {
    ...
    async removeEmployeeFromDepartment(employeeId, departmentId) {
        throw new Error("Method 'removeEmployeeFromDepartment' must be implemented");
    }
    ...
    async addHeadOfDepartmentToDepartment(userId, departmentId) {
        throw new Error("Method 'addHeadOfDepartmentToDepartment' must be implemented");
    }
    async removeHeadOfDepartmentFromDepartment(userId, departmentId) {
        throw new Error("Method 'removeHeadOfDepartmentFromDepartment' must be implemented");
    }
