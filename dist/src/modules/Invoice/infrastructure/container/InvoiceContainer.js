...
export class InvoiceContainer {
    ...
    initializeServices() {
        ...
        this.services.set("createInvoiceUseCase", new CreateInvoiceUseCase(this.get("invoiceRepository"), this.get("customerRepository"), this.get("notificationService"), this.get("auditService")));
        this.services.set("getAllInvoicesUseCase", new GetAllInvoicesUseCase(this.get("invoiceRepository")));
        this.services.set("updateInvoiceUseCase", new UpdateInvoiceUseCase(this.get("invoiceRepository"), this.get("auditService")));
        this.services.set("getInvoiceStatsUseCase", new GetInvoiceStatsUseCase(this.get("invoiceRepository")));
        this.services.set("markOverdueInvoicesUseCase", new MarkOverdueInvoicesUseCase(this.get("invoiceRepository"), this.get("notificationService"), this.get("auditService")));
        // Initialize controllers
        this.services.set("invoiceController", new InvoiceController(this.get("createInvoiceUseCase"), this.get("getAllInvoicesUseCase"), this.get("updateInvoiceUseCase"), this.get("getInvoiceStatsUseCase"), this.get("markOverdueInvoicesUseCase"), this.get("invoiceRepository")));
        // Initialize routes
        this.services.set("invoiceRoutes", new InvoiceRoutes(this.get("invoiceController")));
    }
    get(serviceName) {
...
//# sourceMappingURL=InvoiceContainer.js.map