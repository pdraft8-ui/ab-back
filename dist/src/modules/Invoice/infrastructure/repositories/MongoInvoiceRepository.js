...
export class MongoInvoiceRepository extends IInvoiceRepository {
    ...
    async getAllInvoices(filters = {}) {
        try {
            const { page = 1, limit = 10, status, customerId, startDate, endDate, search, sortBy = "createdAt", sortOrder = "desc", } = filters;
            // Build query
            const query = {};
            if (status) {
                query.status = status;
    ...
    async updateInvoice(id, updateData) {
        try {
            const invoice = await Invoice.findByIdAndUpdate(id, { ...updateData, updatedAt: new Date() }, { new: true })
                .populate("customer", "firstName lastName email")
                .populate("vehicle", "plateNumber model make")
                .populate("createdBy", "firstName lastName")
                .populate("updatedBy", "firstName lastName");
...
//# sourceMappingURL=MongoInvoiceRepository.js.map