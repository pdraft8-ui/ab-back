...
export class HolyLandsReportContainer {
    ...
    initializeDependencies() {
        ...
        this.dependencies.set("holyLandsReportRepository", new MongoHolyLandsReportRepository());
        ...
        this.dependencies.set("createHolyLandsReportUseCase", new CreateHolyLandsReportUseCase({
            holyLandsReportRepository: this.dependencies.get("holyLandsReportRepository"),
        ...
        this.dependencies.set("getAllHolyLandsReportsUseCase", new GetAllHolyLandsReportsUseCase({
            holyLandsReportRepository: this.dependencies.get("holyLandsReportRepository"),
        }));
        this.dependencies.set("getHolyLandsReportByIdUseCase", new GetHolyLandsReportByIdUseCase({
            holyLandsReportRepository: this.dependencies.get("holyLandsReportRepository"),
        }));
        this.dependencies.set("deleteHolyLandsReportUseCase", new DeleteHolyLandsReportUseCase({
            holyLandsReportRepository: this.dependencies.get("holyLandsReportRepository"),
            auditService: this.dependencies.get("auditService"),
            notificationService: this.dependencies.get("notificationService"),
        }));
        this.dependencies.set("getHolyLandsReportStatsUseCase", new GetHolyLandsReportStatsUseCase({
            holyLandsReportRepository: this.dependencies.get("holyLandsReportRepository"),
        }));
        // Presentation Layer
        this.dependencies.set("holyLandsReportController", new HolyLandsReportController({
            createHolyLandsReportUseCase: this.dependencies.get("createHolyLandsReportUseCase"),
            getAllHolyLandsReportsUseCase: this.dependencies.get("getAllHolyLandsReportsUseCase"),
            getHolyLandsReportByIdUseCase: this.dependencies.get("getHolyLandsReportByIdUseCase"),
            deleteHolyLandsReportUseCase: this.dependencies.get("deleteHolyLandsReportUseCase"),
            getHolyLandsReportStatsUseCase: this.dependencies.get("getHolyLandsReportStatsUseCase"),
        }));
        this.dependencies.set("holyLandsReportRoutes", new HolyLandsReportRoutes({
            holyLandsReportController: this.dependencies.get("holyLandsReportController"),
        }));
    }
    get(dependencyName) {
...
//# sourceMappingURL=HolyLandsReportContainer.js.map