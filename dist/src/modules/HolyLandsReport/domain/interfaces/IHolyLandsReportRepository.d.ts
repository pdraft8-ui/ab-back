export class IHolyLandsReportRepository {
    create(holyLandsReport: any): Promise<void>;
    ...
    update(id: any, holyLandsReport: any): Promise<void>;
...
//# sourceMappingURL=IHolyLandsReportRepository.d.ts.map