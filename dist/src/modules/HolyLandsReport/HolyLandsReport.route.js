...
HolyLandsReportRouter.post("/add/:plateNumber", auth(endPoints.addHoliAccidentReport), HolyLandsReportRoute.addNewAccedentReport);
HolyLandsReportRouter.delete("/delete/:id", auth(endPoints.deleteHoliAccidentReport), HolyLandsReportRoute.deleteAccidentReport);
HolyLandsReportRouter.get("/all", auth(endPoints.showHoliAccidentReport), HolyLandsReportRoute.getAllReports);
...
//# sourceMappingURL=HolyLandsReport.route.js.map