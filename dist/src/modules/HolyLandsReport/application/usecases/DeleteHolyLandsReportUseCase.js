export class DeleteHolyLandsReportUseCase {
    ...
    async execute(id, userId, userName) {
        try {
            ...
            const existingAccidentReport = await this.holyLandsReportRepository.findById(id);
            ...
            await this.notificationService.sendNotification({
                ...
                message: `Holy Lands accident report for vehicle ${existingAccidentReport.getVehicleDetails().plateNumber} has been deleted`,
                data: {
...
//# sourceMappingURL=DeleteHolyLandsReportUseCase.js.map