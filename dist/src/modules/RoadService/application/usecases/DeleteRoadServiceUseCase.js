export class DeleteRoadServiceUseCase {
    ...
    async execute(id, userId, userName) {
        try {
            ...
            // Log audit action
            await this.auditService.logAction("DELETE_ROAD_SERVICE", `Deleted road service: ${existingService.companyName}`, userId, userName);
...
//# sourceMappingURL=DeleteRoadServiceUseCase.js.map