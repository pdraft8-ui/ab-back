import { RoadServiceContainer, RoadServiceContainerMinimal, } from "./infrastructure/container/RoadServiceContainer.js";
// Export container getters
export const getRoadServiceContainer = () => new RoadServiceContainer();
export const getRoadServiceContainerMinimal = () => new RoadServiceContainerMinimal();
