...
export class RoadServiceContainer {
    ...
    initializeDependencies() {
        ...
        // Use Cases
        this.createRoadServiceUseCase = new CreateRoadServiceUseCase(this.roadServiceRepository, this.auditService);
        this.getAllRoadServicesUseCase = new GetAllRoadServicesUseCase(this.roadServiceRepository);
        this.getRoadServiceByIdUseCase = new GetRoadServiceByIdUseCase(this.roadServiceRepository);
        this.updateRoadServiceUseCase = new UpdateRoadServiceUseCase(this.roadServiceRepository, this.auditService);
        this.deleteRoadServiceUseCase = new DeleteRoadServiceUseCase(this.roadServiceRepository, this.auditService);
        this.getRoadServiceStatsUseCase = new GetRoadServiceStatsUseCase(this.roadServiceRepository);
        // Presentation
        this.roadServiceController = new RoadServiceController(this.createRoadServiceUseCase, this.getAllRoadServicesUseCase, this.getRoadServiceByIdUseCase, this.updateRoadServiceUseCase, this.deleteRoadServiceUseCase, this.getRoadServiceStatsUseCase);
...
export class RoadServiceContainerMinimal {
    constructor() {
        this.mockRoadServiceRepository = {
            ...
            findById: async (id) => new RoadService({
                id,
            ...
            delete: async (id) => new RoadService({ id, companyName: "Deleted Service" }),
            getStats: async () => ({
                totalServices: 2,
                servicesUnder2007: 1,
                servicesOver2007: 1,
        ...
        this.createRoadServiceUseCase = new CreateRoadServiceUseCase(this.mockRoadServiceRepository, this.mockAuditService);
        this.getAllRoadServicesUseCase = new GetAllRoadServicesUseCase(this.mockRoadServiceRepository);
        this.getRoadServiceByIdUseCase = new GetRoadServiceByIdUseCase(this.mockRoadServiceRepository);
        this.updateRoadServiceUseCase = new UpdateRoadServiceUseCase(this.mockRoadServiceRepository, this.mockAuditService);
        this.deleteRoadServiceUseCase = new DeleteRoadServiceUseCase(this.mockRoadServiceRepository, this.mockAuditService);
        this.getRoadServiceStatsUseCase = new GetRoadServiceStatsUseCase(this.mockRoadServiceRepository);
...
//# sourceMappingURL=RoadServiceContainer.js.map