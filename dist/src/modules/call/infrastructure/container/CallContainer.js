...
export class CallContainer {
    ...
    initializeDependencies() {
        ...
        // Use Cases
        this.getCallRecordingUseCase = new GetCallRecordingUseCase(this.callRepository, this.recordingService);
        this.getAllCallsUseCase = new GetAllCallsUseCase(this.callRepository);
        this.getCallsByCustomerUseCase = new GetCallsByCustomerUseCase(this.callRepository);
        this.getCallStatsUseCase = new GetCallStatsUseCase(this.callRepository);
        // Presentation
        this.callController = new CallController(this.getCallRecordingUseCase, this.getAllCallsUseCase, this.getCallsByCustomerUseCase, this.getCallStatsUseCase);
...
export class CallContainerMinimal {
    constructor() {
        this.mockCallRepository = {
            ...
            findByCallId: async (callid) => new Call({
                id: "mock-id",
                callid,
        ...
        this.getCallRecordingUseCase = new GetCallRecordingUseCase(this.mockCallRepository, this.mockRecordingService);
        this.getAllCallsUseCase = new GetAllCallsUseCase(this.mockCallRepository);
        this.getCallsByCustomerUseCase = new GetCallsByCustomerUseCase(this.mockCallRepository);
...
//# sourceMappingURL=CallContainer.js.map