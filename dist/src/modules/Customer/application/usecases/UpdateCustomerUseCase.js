    ...
    async execute(customerId, updateData, userId, userName) {
        try {
            ...
            if (updateData.id_Number &&
                ...
                const existingCustomerWithId = await this.customerRepository.getCustomerByIdNumber(updateData.id_Number);
            ...
            // Update customer
            const updatedCustomer = await this.customerRepository.updateCustomer(customerId, updateData);
            // Log audit
