export class ITakafulAccidentReportRepository {
    create(accidentReportData: any): Promise<void>;
    ...
    update(id: any, accidentReportData: any): Promise<void>;
...
//# sourceMappingURL=ITakafulAccidentReportRepository.d.ts.map