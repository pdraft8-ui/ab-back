export class TakafulAccidentReport {
    ...
    isValidAccidentInfo() {
        return !!(this.accidentInfo?.reportDate &&
    ...
    isValidPolicyInfo() {
        return !!(this.policyInfo?.policyNumber &&
    ...
    isValidCustomerPerson() {
        return !!(this.customerPerson?.name &&
    ...
    isValidCustomerVehicle() {
        return !!(this.customerVehicle?.plateNumber &&
    ...
    isValidDamage() {
        return !!(this.customerVehicle?.damage?.front &&
    ...
    isValidPoliceAndWitnesses() {
        return !!(this.policeAndWitnesses?.reportedDate &&
    ...
    isValidDeclaration() {
        return !!(this.declaration?.declarerName &&
    ...
    updateAccidentReport(data) {
        ...
        if (data.passengers)
            this.passengers = data.passengers;
        if (data.accidentNarration)
            this.accidentNarration = data.accidentNarration;
        if (data.notifierSignature)
            this.notifierSignature = data.notifierSignature;
        if (data.receiverName)
            this.receiverName = data.receiverName;
        if (data.receiverNotes)
            this.receiverNotes = data.receiverNotes;
        if (data.declaration)
...
//# sourceMappingURL=TakafulAccidentReport.entity.js.map