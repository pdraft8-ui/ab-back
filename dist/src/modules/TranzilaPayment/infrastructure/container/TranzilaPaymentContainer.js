...
export class TranzilaPaymentContainer {
    ...
    initializeServices() {
        ...
        this.services.set("tranzilaPaymentRepository", new MongoTranzilaPaymentRepository());
        ...
        this.services.set("createTranzilaPaymentUseCase", new CreateTranzilaPaymentUseCase(this.services.get("tranzilaPaymentRepository"), this.services.get("tranzilaService"), this.services.get("invoiceRepository"), this.services.get("customerRepository"), this.services.get("notificationService")));
        // Initialize controllers
        this.services.set("tranzilaPaymentController", new TranzilaPaymentController(this.services.get("createTranzilaPaymentUseCase"), this.services.get("tranzilaPaymentRepository"), this.services.get("tranzilaService"), this.services.get("notificationService")));
        // Initialize routes
        this.services.set("tranzilaPaymentRoutes", new TranzilaPaymentRoutes(this.services.get("tranzilaPaymentController")));
    }
...
export class TranzilaPaymentContainerMinimal {
    ...
    initializeMockServices() {
        ...
        const mockTranzilaPaymentRepository = {
            createTranzilaPayment: async (data) => new (await import("../../domain/entities/TranzilaPayment.entity.js")).TranzilaPayment(data),
            findTranzilaPaymentByPaymentId: async (id) => new (await import("../../domain/entities/TranzilaPayment.entity.js")).TranzilaPayment({ id, paymentId: id }),
            updateTranzilaPayment: async (id, data) => new (await import("../../domain/entities/TranzilaPayment.entity.js")).TranzilaPayment({ id, ...data }),
        ...
        const mockNotificationService = {
            sendPaymentCreatedNotification: async (payment, invoice, customer) => true,
            sendRefundNotification: async (payment, amount, reason) => true,
        };
        this.services.set("tranzilaPaymentRepository", mockTranzilaPaymentRepository);
...
//# sourceMappingURL=TranzilaPaymentContainer.js.map