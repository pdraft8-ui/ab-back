...
export const createChequeValidation = joi.object({
    ...
    chequeStatus: joi
        ...
        .default("pending")
        .messages({
        "any.only": "Cheque status must be one of: pending, cleared, bounced, cancelled, on_hold",
    }),
...
export const getChequeFiltersValidation = joi.object({
    ...
    sortBy: joi
        .string()
        .valid("chequeDate", "chequeAmount", "createdAt", "chequeStatus", "customerName", "customerPhone")
        .default("createdAt")
        .optional()
        .messages({
        "any.only": "Sort by must be one of: chequeDate, chequeAmount, createdAt, chequeStatus, customerName, customerPhone",
    }),
    sortOrder: joi
        .string()
        .valid("asc", "desc")
...
//# sourceMappingURL=cheque.validation.js.map