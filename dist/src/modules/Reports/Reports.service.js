...
class ReportsService {
    ...
    async getChequeReport(filters = {}) {
        try {
            const { startDate, endDate, status, page = 1, limit = 10, sortBy = "createdAt", sortOrder = "desc", } = filters;
    ...
    async getDueAmountsReport(filters = {}) {
        try {
            const { startDate, endDate, status, page = 1, limit = 10, sortBy = "balanceDue", sortOrder = "desc", } = filters;
            // Build match conditions
            const matchConditions = {
    ...
    async getAgentCustomersReport(filters = {}) {
        try {
            const { agentId, startDate, endDate, page = 1, limit = 10, sortBy = "createdAt", sortOrder = "desc", } = filters;
    ...
    async getAgentInsurancesReport(filters = {}) {
        try {
            const { agentId, insuranceType, startDate, endDate, page = 1, limit = 10, sortBy = "createdAt", sortOrder = "desc", } = filters;
    ...
    async getExpiredInsuranceReport(filters = {}) {
        try {
            const { daysThreshold = 3, includeExpired = true, page = 1, limit = 10, sortBy = "expirationDate", sortOrder = "asc", } = filters;
            const now = new Date();
