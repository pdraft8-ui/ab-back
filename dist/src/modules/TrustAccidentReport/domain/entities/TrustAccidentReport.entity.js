export class TrustAccidentReport {
    ...
    isValidAccidentDetails() {
        return (this.accidentDetails.location &&
    ...
    isValidDriverDetails() {
        return (this.driverDetails.name &&
    ...
    isValidOtherVehicle() {
        return (this.otherVehicle.plateNumber &&
    ...
    isValidWitnesses() {
        return (Array.isArray(this.witnesses) &&
            this.witnesses.every((witness) => witness.name && witness.address && witness.phone));
    }
    isValidPoliceReport() {
        return (this.policeReport.reportDate &&
...
//# sourceMappingURL=TrustAccidentReport.entity.js.map