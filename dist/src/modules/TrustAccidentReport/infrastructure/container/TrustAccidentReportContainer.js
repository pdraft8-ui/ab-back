...
export class TrustAccidentReportContainer {
    ...
    initializeDependencies() {
        // Bind repositories
        this.dependencies.set("trustAccidentReportRepository", new MongoTrustAccidentReportRepository());
        ...
        // Bind use cases
        this.dependencies.set("createTrustAccidentReportUseCase", new CreateTrustAccidentReportUseCase(this.dependencies.get("trustAccidentReportRepository"), this.dependencies.get("customerRepository"), this.dependencies.get("auditService"), this.dependencies.get("notificationService")));
        this.dependencies.set("getAllTrustAccidentReportsUseCase", new GetAllTrustAccidentReportsUseCase(this.dependencies.get("trustAccidentReportRepository")));
        this.dependencies.set("getTrustAccidentReportByIdUseCase", new GetTrustAccidentReportByIdUseCase(this.dependencies.get("trustAccidentReportRepository")));
        this.dependencies.set("deleteTrustAccidentReportUseCase", new DeleteTrustAccidentReportUseCase(this.dependencies.get("trustAccidentReportRepository"), this.dependencies.get("auditService"), this.dependencies.get("notificationService")));
        this.dependencies.set("getTrustAccidentReportStatsUseCase", new GetTrustAccidentReportStatsUseCase(this.dependencies.get("trustAccidentReportRepository")));
        // Bind controller
        this.dependencies.set("trustAccidentReportController", new TrustAccidentReportController(this.dependencies.get("createTrustAccidentReportUseCase"), this.dependencies.get("getAllTrustAccidentReportsUseCase"), this.dependencies.get("getTrustAccidentReportByIdUseCase"), this.dependencies.get("deleteTrustAccidentReportUseCase"), this.dependencies.get("getTrustAccidentReportStatsUseCase")));
        // Bind routes
        this.dependencies.set("trustAccidentReportRoutes", new TrustAccidentReportRoutes(this.dependencies.get("trustAccidentReportController")));
    }
    get(key) {
...
export class TrustAccidentReportContainerMinimal {
    ...
    initializeDependencies() {
        ...
        // Bind dependencies
        this.dependencies.set("trustAccidentReportRepository", mockTrustAccidentReportRepository);
        ...
        // Bind use cases
        this.dependencies.set("createTrustAccidentReportUseCase", new CreateTrustAccidentReportUseCase(mockTrustAccidentReportRepository, mockCustomerRepository, mockAuditService, mockNotificationService));
        this.dependencies.set("getAllTrustAccidentReportsUseCase", new GetAllTrustAccidentReportsUseCase(mockTrustAccidentReportRepository));
        this.dependencies.set("getTrustAccidentReportByIdUseCase", new GetTrustAccidentReportByIdUseCase(mockTrustAccidentReportRepository));
        this.dependencies.set("deleteTrustAccidentReportUseCase", new DeleteTrustAccidentReportUseCase(mockTrustAccidentReportRepository, mockAuditService, mockNotificationService));
        this.dependencies.set("getTrustAccidentReportStatsUseCase", new GetTrustAccidentReportStatsUseCase(mockTrustAccidentReportRepository));
        // Bind controller
        this.dependencies.set("trustAccidentReportController", new TrustAccidentReportController(this.dependencies.get("createTrustAccidentReportUseCase"), this.dependencies.get("getAllTrustAccidentReportsUseCase"), this.dependencies.get("getTrustAccidentReportByIdUseCase"), this.dependencies.get("deleteTrustAccidentReportUseCase"), this.dependencies.get("getTrustAccidentReportStatsUseCase")));
        // Bind routes
        this.dependencies.set("trustAccidentReportRoutes", new TrustAccidentReportRoutes(this.dependencies.get("trustAccidentReportController")));
...
//# sourceMappingURL=TrustAccidentReportContainer.js.map