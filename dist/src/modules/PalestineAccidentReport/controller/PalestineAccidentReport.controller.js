    ...
    try {
        ...
        if (!vehicle) {
            return res.status(404).json({
                message: "The vehicle was not found in the customer person's vehicle list",
            });
        }
        const driverInfo = {
        ...
        if (req.body.driverInfo.license &&
...
export const findById = async (req, res) => {
    try {
        ...
        return res
            .status(500)
            .json({ message: "An error occurred while fetching the report" });
    }
};
//# sourceMappingURL=PalestineAccidentReport.controller.js.map