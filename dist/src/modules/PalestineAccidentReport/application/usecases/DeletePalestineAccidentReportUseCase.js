export class DeletePalestineAccidentReportUseCase {
    ...
    async execute(id, userId, userName) {
        try {
            ...
            const existingAccidentReport = await this.palestineAccidentReportRepository.findById(id);
            ...
            await this.notificationService.sendNotification({
                ...
                message: `Palestine accident report for vehicle ${existingAccidentReport.getVehicleInfo().vehicleNumber} has been deleted`,
                data: {
            ...
            throw new Error(`DeletePalestineAccidentReportUseCase error: ${error.message}`);
        }
    }
}
//# sourceMappingURL=DeletePalestineAccidentReportUseCase.js.map