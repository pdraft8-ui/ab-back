export class GetPalestineAccidentReportByIdUseCase {
    ...
    async execute(id) {
        try {
            ...
            const accidentReport = await this.palestineAccidentReportRepository.findById(id);
            if (!accidentReport) {
            ...
            throw new Error(`GetPalestineAccidentReportByIdUseCase error: ${error.message}`);
        }
    }
}
//# sourceMappingURL=GetPalestineAccidentReportByIdUseCase.js.map