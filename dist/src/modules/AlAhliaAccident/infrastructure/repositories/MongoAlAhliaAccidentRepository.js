...
export class MongoAlAhliaAccidentRepository extends IAlAhliaAccidentRepository {
    ...
    async findByCustomerId(customerId) {
        try {
            ...
            throw new Error(`Failed to find AlAhliaAccident by customer ID: ${error.message}`);
        }
    }
    async findByPlateNumber(plateNumber) {
        try {
            ...
            throw new Error(`Failed to find AlAhliaAccident by plate number: ${error.message}`);
        }
    }
    async findAll() {
        try {
    ...
    async update(id, alAhliaAccident) {
        try {
            ...
            const mongooseDoc = await AhliAccidentReportModel.findByIdAndUpdate(id, accidentData, { new: true });
            return this.mapToAlAhliaAccidentEntity(mongooseDoc);
        }
        catch (error) {
    ...
    async countAccidentReports() {
        try {
            ...
            throw new Error(`Failed to count AlAhliaAccident reports: ${error.message}`);
        }
    }
    async findByDateRange(startDate, endDate) {
        try {
            ...
            throw new Error(`Failed to find AlAhliaAccident by date range: ${error.message}`);
        }
    }
    async findByAccidentType(accidentType) {
        try {
            ...
            throw new Error(`Failed to find AlAhliaAccident by accident type: ${error.message}`);
        }
    }
}
//# sourceMappingURL=MongoAlAhliaAccidentRepository.js.map