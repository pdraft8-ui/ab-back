...
export class AlAhliaAccidentContainer {
    ...
    initializeDependencies() {
        ...
        this.dependencies.set("alAhliaAccidentRepository", new MongoAlAhliaAccidentRepository());
        ...
        this.dependencies.set("createAlAhliaAccidentUseCase", new CreateAlAhliaAccidentUseCase({
            alAhliaAccidentRepository: this.dependencies.get("alAhliaAccidentRepository"),
        ...
        this.dependencies.set("getAllAlAhliaAccidentsUseCase", new GetAllAlAhliaAccidentsUseCase({
            alAhliaAccidentRepository: this.dependencies.get("alAhliaAccidentRepository"),
        }));
        this.dependencies.set("getAlAhliaAccidentByIdUseCase", new GetAlAhliaAccidentByIdUseCase({
            alAhliaAccidentRepository: this.dependencies.get("alAhliaAccidentRepository"),
        }));
        this.dependencies.set("deleteAlAhliaAccidentUseCase", new DeleteAlAhliaAccidentUseCase({
            alAhliaAccidentRepository: this.dependencies.get("alAhliaAccidentRepository"),
            auditService: this.dependencies.get("auditService"),
            notificationService: this.dependencies.get("notificationService"),
        }));
        this.dependencies.set("getAlAhliaAccidentStatsUseCase", new GetAlAhliaAccidentStatsUseCase({
            alAhliaAccidentRepository: this.dependencies.get("alAhliaAccidentRepository"),
        }));
        // Presentation layer
        this.dependencies.set("alAhliaAccidentController", new AlAhliaAccidentController({
            createAlAhliaAccidentUseCase: this.dependencies.get("createAlAhliaAccidentUseCase"),
            getAllAlAhliaAccidentsUseCase: this.dependencies.get("getAllAlAhliaAccidentsUseCase"),
            getAlAhliaAccidentByIdUseCase: this.dependencies.get("getAlAhliaAccidentByIdUseCase"),
            deleteAlAhliaAccidentUseCase: this.dependencies.get("deleteAlAhliaAccidentUseCase"),
            getAlAhliaAccidentStatsUseCase: this.dependencies.get("getAlAhliaAccidentStatsUseCase"),
        }));
        this.dependencies.set("alAhliaAccidentRoutes", new AlAhliaAccidentRoutes(this.dependencies.get("alAhliaAccidentController")));
    }
    get(key) {
    ...
    initializeDependencies() {
        ...
        const mockAlAhliaAccidentRepository = {
            create: async (alAhliaAccident) => {
                console.log("Mock AlAhliaAccidentRepository.create:", alAhliaAccident.toJSON());
            ...
            findByCustomerId: async (customerId) => {
                console.log("Mock AlAhliaAccidentRepository.findByCustomerId:", customerId);
                return [];
            },
            findByPlateNumber: async (plateNumber) => {
                console.log("Mock AlAhliaAccidentRepository.findByPlateNumber:", plateNumber);
                return [];
            },
            findAll: async () => {
            ...
            update: async (id, alAhliaAccident) => {
                console.log("Mock AlAhliaAccidentRepository.update:", id, alAhliaAccident.toJSON());
                return alAhliaAccident;
            },
            delete: async (id) => {
            ...
            findByDateRange: async (startDate, endDate) => {
                console.log("Mock AlAhliaAccidentRepository.findByDateRange:", startDate, endDate);
                return [];
            },
            findByAccidentType: async (accidentType) => {
                console.log("Mock AlAhliaAccidentRepository.findByAccidentType:", accidentType);
                return [];
            },
        };
        this.dependencies.set("alAhliaAccidentRepository", mockAlAhliaAccidentRepository);
        // Mock services
        this.dependencies.set("auditService", {
            logAction: async (data) => {
                console.log("Mock AuditService.logAction:", data);
...
//# sourceMappingURL=AlAhliaAccidentContainer.js.map