...
export async function getAlAhliaAccidentRoutes() {
    const { AlAhliaAccidentContainer } = await import("./infrastructure/container/AlAhliaAccidentContainer.js");
...
export async function getAlAhliaAccidentContainerMinimal() {
    const { AlAhliaAccidentContainerMinimal } = await import("./infrastructure/container/AlAhliaAccidentContainer.js");
