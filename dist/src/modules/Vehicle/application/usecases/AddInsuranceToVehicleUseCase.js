    ...
    async execute(vehicleId, insuranceData, userId, userName) {
        try {
            ...
            for (const field of requiredFields) {
                if (insuranceData[field] === undefined ||
            ...
            const updatedVehicle = await this.vehicleRepository.addInsuranceToVehicle(vehicleId, insuranceData);
            // Log audit
...
//# sourceMappingURL=AddInsuranceToVehicleUseCase.js.map