 ...
 */
export class Cheque {
    constructor({ id, chequeNumber, amount, bankName, branchName, accountNumber, issueDate, dueDate, status = "Pending", customer, invoice, notes, imageUrl, createdBy, updatedBy, createdAt, updatedAt, }) {
        this.id = id;
