...
export class ChequeController {
    ...
    async createCheque(req, res) {
        try {
            ...
            const result = await this.createChequeUseCase.execute(chequeData, req.user);
            if (result.success) {
    ...
    async updateChequeStatus(req, res) {
        try {
            ...
            const updatedCheque = await this.chequeRepository.updateStatus(id, status);
            if (!updatedCheque) {
                return res.status(404).json({
                    success: false,
                    message: "Cheque not found",
    ...
    async getChequeStats(req, res) {
        try {
            ...
            const totalAmountByStatus = await this.chequeRepository.getTotalAmountByStatus();
            return res.status(200).json({
                success: true,
...
//# sourceMappingURL=ChequeController.js.map