...
export class MongoDocumentSettingsRepository extends IDocumentSettingsRepository {
    ...
    async update(id, settingsData) {
        try {
            const settings = await DocumentSettingsModel.findByIdAndUpdate(id, { ...settingsData, updatedAt: new Date() }, { new: true });
            return this.mapToDocumentSettingsEntity(settings);
        }
        catch (error) {
    ...
    async updateHeaderLogo(id, logoData) {
        try {
            const settings = await DocumentSettingsModel.findByIdAndUpdate(id, {
...
//# sourceMappingURL=MongoDocumentSettingsRepository.js.map