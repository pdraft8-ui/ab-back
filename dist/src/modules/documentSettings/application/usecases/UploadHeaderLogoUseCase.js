export class UploadHeaderLogoUseCase {
    ...
    async execute(documentType, logoData, userId, userName) {
        try {
            ...
            const updatedSettings = await this.documentSettingsRepository.updateHeaderLogo(existingSettings.id, logoData);
            // Log audit action
...
//# sourceMappingURL=UploadHeaderLogoUseCase.js.map