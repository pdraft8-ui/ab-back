export class IPaymentRepository {
    ...
    getPaymentsByCustomer(customerId: any, filters?: {}): Promise<void>;
    getPaymentsByInvoice(invoiceId: any, filters?: {}): Promise<void>;
    getPaymentStats(filters?: {}): Promise<void>;
    refundPayment(id: any, refundData: any): Promise<void>;
