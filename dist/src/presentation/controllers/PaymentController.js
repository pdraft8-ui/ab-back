...
export class PaymentController {
    ...
    async getPaymentsByCustomer(req, res, next) {
        try {
            ...
            const filters = req.query;
            const payments = await this.paymentRepository.getPaymentsByCustomer(customerId, filters);
            res.status(200).json({
                success: true,
    ...
    async getPaymentsByInvoice(req, res, next) {
        try {
            ...
            const filters = req.query;
            const payments = await this.paymentRepository.getPaymentsByInvoice(invoiceId, filters);
            res.status(200).json({
                success: true,
