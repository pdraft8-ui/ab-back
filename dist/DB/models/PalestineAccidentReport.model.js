...
const agentInfoSchema = new Schema({
    ...
    documentType: { type: String, enum: ["comprehensive", "thirdParty"] },
    insurancePeriod: {
        from: Date,
        to: Date,
    },
...
const PalestineAccidentReportModel = mongoose.models.AccidentReportPalestine ||
    mongoose.model("AccidentReportPalestine", accidentPalestineReportSchema);
export default PalestineAccidentReportModel;
//# sourceMappingURL=PalestineAccidentReport.model.js.map